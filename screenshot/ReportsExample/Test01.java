...
public class Test01 extends commonMethods{
	...
	public static void main(String [] args) throws InterruptedException, IOException
	{
		...
		System.err.println(Test01.class.getName());
		Test= common.createTest1(Test01.class.getName());
		...
		common.ExtentScreenshot(driver, Test);
		common.stopTest();
